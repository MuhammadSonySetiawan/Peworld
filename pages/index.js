    ...
    <>
      <div id="home_page">
        ...
        <header className="container content-to-center">
          <div className="row d-flex justify-content-between align-items-center flex-wrap-reverse">
            <div className="col-md-5">
              ...
              <p className="d-block mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In euismod ipsum et dui rhoncus auctor.</p>
              <Link href="/register">
            ...
            <div className="col-md-5 mb-3">
              ...
              <div className="position-relative img-fluid">
                <img src="/home_1.jpg" alt="Home Picture" className="img-fluid rounded" style={{ alignSelf: "center" }} />
              </div>
            </div>
          </div>
        </header>
        ...
        <section className="container ">
          <div className="row justify-content-end d-flex flex-wrap-reverse">
              ...
              <div className="row">
                <div className="col-md-6 d-flex flex-wrap">
                  {["Java", "Kotlin", "PHP", "Javascript"].map((item, key) => (
                    <div className="d-flex align-items-center mb-3 me-5" key={key}>
                      <img src="/circleCheckYellow.svg" style={{ marginRight: "20px" }} />
                      <p className="mb-0">{item}</p>
                    </div>
                  ))}
                </div>
                <div className="col-md-6 d-flex flex-wrap">
                  {["Golang", "C++", "Ruby", "10+ Bahasa lainnya"].map((item, key) => (
                    <div className="d-flex align-items-center mb-3 me-5" key={key}>
                      <img src="/circleCheckYellow.svg" style={{ marginRight: "20px" }} />
                      <p className="mb-0">{item}</p>
                    </div>
            ...
            <div className="col-md-5 mb-3">
              ...
              ></div>
              <div className="position-relative img-fluid">
                <img src="/home_3.jpg" alt="Home Picture" className="img-fluid rounded" style={{ alignSelf: "center" }} />
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="mt-5 mb-5 d-flex justify-content-center">
          <div className="bg-primary d-flex justify-content-between align-items-center bgButton" style={{ height: "200px", width: "60%", borderRadius: "50px 2px" }}>
            <div className="ms-5">
            ...
            <button type="button" class="btn btn-light me-5 bgButtonDown" style={{ width: "40%", height: "50px", fontSize: "20px" }}>
              Mulai dari sekarang
            </button>
          </div>
        </div>
